...
public class Help extends Command {
  ...
  public void run(@NotNull CommandContext ctx) {
    ...
    builder.append("**Name:** ").append(cmd.getName().substring(0, 1).toUpperCase())
            .append(cmd.getName().substring(1)).append("**Description:** ")
            .append(cmd.getDescription());
    if (cmd.getAliases().length > 0)
      builder.append("\n**Aliases:** ").append(String.join(
              " | ",
    ...
    if (cmd.getCd() > 0)
      builder.append("\n**Cool Down:** ").append(cmd.getCd() / 1000).append(" seconds(s)");
    ...
    EmbedBuilder embed = Utils.embed()
            ...
            .setColor(Utils.getHex())
            .addField("General Info", builder.toString().trim(), false)
